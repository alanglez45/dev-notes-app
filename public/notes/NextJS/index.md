...
## Core
- [Next.js Overview](01-nextjs.md) - Instalación, comandos, Turbopack, Tailwind
...
## Components
- [Server Components](04-server-components.md) - Componentes de servidor (por defecto), ventajas, limitaciones
- [Client Components](05-client-components.md) - Directiva 'use client', interactividad, hooks

## Data & API
- [Data Fetching](06-data-fetching.md) - Fetch en server components, async/await, caching, loading/error states
